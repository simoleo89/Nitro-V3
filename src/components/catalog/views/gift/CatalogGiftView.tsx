...
export const CatalogGiftView: FC = (props) => {
    ...
    const isBoxDefault = useMemo(() => {
        return giftConfiguration
            ? giftConfiguration.defaultStuffTypes.findIndex((s) => s === boxTypes[selectedBoxIndex]) > -1
            : false;
            ...
            <NitroCardContentView className="text-black">
                        ...
                        <Column className="autocomplete-gift-container">
                            {suggestions.map((friend: MessengerFriend) => (
                                <div
                                    ...
                                    onClick={(e) => selectedReceiverName(friend.name)}
                                >
                                    {friend.name}
                                </div>
                            ))}
                ...
                <div className="form-check">
                    <input
                        ...
                        name="showMyFace"
                        type="checkbox"
                        onChange={(e) => setShowMyFace((value) => !value)}
                    />
                ...
                <div className="items-center gap-2">
                    <div className="gift-preview">
                        {colourId > 0 && boxExtraData && (
                            <LayoutFurniImageView
                                extraData={boxExtraData}
                                productClassId={colourId}
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div
                            className={`flex items-center gap-2 ${isColorable ? '' : 'opacity-50 pointer-events-none'}`}
                        >
                            <div className="inline-flex">
