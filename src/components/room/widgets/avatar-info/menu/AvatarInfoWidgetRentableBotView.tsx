...
export const AvatarInfoWidgetRentableBotView: FC<AvatarInfoWidgetRentableBotViewProps> = (props) => {
    ...
    const requestBotCommandConfiguration = (skillType: number) =>
        SendMessageComposer(new RequestBotCommandConfigurationComposer(avatarInfo.webID, skillType));
    ...
    const processAction = (name: string) => {
        ...
        if (name) {
            switch (name) {
                ...
                case 'save_bot_name':
                    SendMessageComposer(
                        new BotSkillSaveComposer(avatarInfo.webID, BotSkillsEnum.CHANGE_BOT_NAME, newName),
                    );
                    break;
                ...
                case 'save_bot_motto':
                    SendMessageComposer(
                        new BotSkillSaveComposer(avatarInfo.webID, BotSkillsEnum.CHANGE_BOT_MOTTO, newMotto),
                    );
                    break;
                case 'dress_up':
