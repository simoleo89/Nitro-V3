...
const PagBtn: FC<{ disabled?: boolean; onClick: () => void; children: ReactNode; title?: string }> = ({
    disabled,
    onClick,
    children,
    title,
                    ...
                    <tbody>
                        {items.map((item) => (
                            ...
                            >
                                ...
                                <td
                                    className="px-2 py-1.5 text-slate-700 font-medium truncate max-w-[160px]"
                                    title={item.itemName}
                                >
                                    {item.itemName}
                                </td>
                                <td
                                    className="px-2 py-1.5 text-slate-500 truncate max-w-[150px]"
