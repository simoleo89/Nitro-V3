...
export const WiredActionFurniToFurniView: FC<{}> = () => {
    ...
    useEffect(() => {
        ...
        const nextMoveSource =
            trigger.intData.length >= 1 ? trigger.intData[0] : nextMoveIds.length ? SOURCE_SELECTED : SOURCE_TRIGGER;
        const nextTargetSourceRaw =
        ...
        const nextTargetSource =
            nextTargetSourceRaw === SOURCE_SELECTED ? SOURCE_SECONDARY_SELECTED : nextTargetSourceRaw;
    ...
    useEffect(() => {
        ...
        setAllowsFurni(
            canEditCurrent ? WiredFurniType.STUFF_SELECTION_OPTION_BY_ID : WiredFurniType.STUFF_SELECTION_OPTION_NONE,
        );
    ...
    const save = useCallback(() => {
        ...
        setIntParams([moveSource, targetSource]);
