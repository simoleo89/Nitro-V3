...
export const ToolbarView: FC<{ isInRoom: boolean }> = props =>
{
    ...
    return (
        <>
            ...
            <Flex alignItems="center" className="absolute bottom-0 left-0 w-full h-[55px] bg-[var(--theme-dark-bg-95,rgba(28,28,32,.95))] [box-shadow:inset_0_5px_#22222799,inset_0_-4px_#12121599] py-1 px-3" gap={ 2 }>
