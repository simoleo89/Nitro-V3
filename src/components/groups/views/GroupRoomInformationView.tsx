...
export const GroupRoomInformationView: FC<{}> = (props) => {
    ...
    useMessageEvent<HabboGroupDeactivatedMessageEvent>(HabboGroupDeactivatedMessageEvent, (event) => {
        ...
        if (
            !groupInformation ||
            (parser.groupId !== groupInformation.id && parser.groupId !== expectedGroupIdRef.current)
        )
            return;
                ...
                >
                    <Flex alignItems="center" gap={1} className={isCompact ? 'mr-[0]' : ''}>
                        ...
                        {!isCompact && (
                            <Text
                                variant="white"
                                className="text-[0.78rem] font-bold leading-none text-white/90 max-[420px]:text-[0.74rem]"
                            >
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1">
                                <Text
                                    truncate
                                    variant="white"
                                    className="text-[0.82rem] font-bold leading-tight text-white/92 max-[420px]:text-[0.76rem]"
                                >
