...
export const WiredExtraFilterByVariableView: FC<WiredExtraFilterByVariableViewProps> = ({ target }) => {
    ...
    const referenceSourceOptions = useMemo(() => {
        if (referenceTargetType === 'furni')
            return resolveSourceOptions(SECONDARY_FURNI_SOURCES, selectedReferenceSourceValue, SECONDARY_FURNI_SOURCES);
    ...
    useEffect(() => {
        ...
        setAmountMode(
            (trigger.intData.length > 1 ? trigger.intData[1] : AMOUNT_CONSTANT) === AMOUNT_VARIABLE
                ? 'variable'
                : 'constant',
        );
            ...
            <div className="nitro-wired__give-var">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <select
                        ...
                        value={sortBy}
                        onChange={(event) => setSortBy(parseInt(event.target.value, 10) || 0)}
                    >
                ...
                <div className="nitro-wired__give-var-section">
                    ...
                    <label className="nitro-wired__change-var-radio">
                        <input
                            checked={amountMode === 'constant'}
                            type="radio"
                            onChange={() => setAmountMode('constant')}
                        />
