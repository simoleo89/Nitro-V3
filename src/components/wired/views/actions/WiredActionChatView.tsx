...
export const WiredActionChatView: FC = (props) => {
    ...
    useEffect(() => {
        ...
        if (trigger.intData.length >= 3 && SHOW_MESSAGE_STYLE_IDS.includes(trigger.intData[2]))
            setBubbleStyle(trigger.intData[2]);
            ...
            <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        value={bubbleStyle}
                        onChange={(event) => setBubbleStyle(Number(event.target.value))}
                    >
