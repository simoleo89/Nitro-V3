...
export const FurnitureStickieView: FC<{}> = (props) => {
    ...
    return (
        <DraggableWindow handleSelector=".drag-handler" windowPosition={DraggableWindowPosition.TOP_LEFT}>
            <div
                className={
                    'nitro-stickie nitro-stickie-image stickie-' +
                    (type == 'post_it' ? getStickieColorName(color) : getStickieTypeName(type))
                }
            >
                <div className="flex items-center stickie-header drag-handler">
                    ...
                    <div
                        className="flex items-center nitro-stickie-image stickie-close header-close"
                        onClick={onClose}
                    ></div>
                </div>
