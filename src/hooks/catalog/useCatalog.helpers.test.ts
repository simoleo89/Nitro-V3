...
describe('resolveBuilderFurniPlaceableStatus', () => {
    ...
    it('returns MISSING_OFFER when offer is null', () => {
        expect(resolveBuilderFurniPlaceableStatus({ ...baseInput, offer: null })).toBe(
            BuilderFurniPlaceableStatus.MISSING_OFFER,
        );
    });

    it('returns NOT_IN_ROOM when roomSession is null', () => {
        expect(resolveBuilderFurniPlaceableStatus({ ...baseInput, roomSession: null })).toBe(
            BuilderFurniPlaceableStatus.NOT_IN_ROOM,
        );
    });
