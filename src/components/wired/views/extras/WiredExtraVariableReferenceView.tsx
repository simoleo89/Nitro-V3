...
export const WiredExtraVariableReferenceView: FC = () => {
    ...
    const selectedRoom = useMemo(
        () => mergedRoomOptions.find((option) => option.roomId === sourceRoomId) ?? null,
        [mergedRoomOptions, sourceRoomId],
    );
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <select
                        ...
                        onChange={(event) => {
                            const [nextItemId, nextTargetType] = event.target.value
                                .split(':')
                    ...
                    >
                        ...
                        {selectedRoomVariables.map((variable) => (
                            <option
                                key={`${variable.itemId}:${variable.targetType}`}
                                value={`${variable.itemId}:${variable.targetType}`}
                            >
