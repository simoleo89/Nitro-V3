...
export const OfferWindowView = (props: { offer: TargetedOfferData; setOpen: Dispatch<SetStateAction<boolean>> }) => {
    ...
    const canPurchase = useMemo(() => {
        ...
        if (offer.priceInActivityPoints > 0)
            points = getCurrencyAmount(offer.activityPointType) >= offer.priceInActivityPoints;
        else points = true;
            ...
            <NitroCardContentView gap={1}>
                <Flex fullHeight gap={1}>
                    ...
                    <div
                        ...
                        style={{
                            background: `url(${GetConfigurationValue('image.library.url') + offer.imageUrl}) no-repeat center`,
                        }}
                    />
                </Flex>
