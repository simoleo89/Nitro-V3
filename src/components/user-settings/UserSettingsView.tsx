            ...
            <NitroCardContentView className="text-black">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                {userSettings.volumeSystem === 0 && (
                                    <FaVolumeMute
                                        className={classNames(
                                            userSettings.volumeSystem >= 50 && 'text-muted',
                                            'fa-icon',
                                        )}
                                    />
                                )}
                                ...
                                />
                                <FaVolumeUp
                                    className={classNames(userSettings.volumeSystem < 50 && 'text-muted', 'fa-icon')}
                                />
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                {userSettings.volumeFurni === 0 && (
                                    <FaVolumeMute
                                        className={classNames(
                                            userSettings.volumeFurni >= 50 && 'text-muted',
                                            'fa-icon',
                                        )}
                                    />
                                )}
                                ...
                                />
                                <FaVolumeUp
                                    className={classNames(userSettings.volumeFurni < 50 && 'text-muted', 'fa-icon')}
                                />
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                {userSettings.volumeTrax === 0 && (
                                    <FaVolumeMute
                                        className={classNames(userSettings.volumeTrax >= 50 && 'text-muted', 'fa-icon')}
                                    />
                                )}
                                {userSettings.volumeTrax > 0 && (
                                    <FaVolumeDown
                        ...
                        >
                            ...
                            <div className="flex flex-col flex-1 leading-tight">
                                ...
                                <Text small className="text-black/60">
                                    {LocalizeText('usersettings.open.subtitle')}
                                </Text>
                            </div>
                ...
                {section !== null && (
                    <div className="flex pt-2 mt-1 border-t border-black/10">
                        <Button variant="secondary" onClick={(event) => processAction('close_view')}>
                            {localizeWithFallback('generic.back', 'Indietro')}
                        </Button>
                    </div>
                )}
