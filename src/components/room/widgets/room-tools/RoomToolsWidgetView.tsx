            ...
            <div className="flex flex-col items-center justify-center p-2 nitro-room-tools">
                ...
                <div
                    className={classNames(
                        'cursor-pointer',
                        'nitro-icon',
                        !isZoomedIn && 'icon-zoom-less',
                        isZoomedIn && 'icon-zoom-more',
                    )}
                ...
                <div
                    className={classNames(
                        'cursor-pointer',
                        'nitro-icon',
                        areBubblesMuted ? 'icon-chat-disablebubble' : 'icon-chat-enablebubble',
                    )}
                    title={
                        areBubblesMuted
                            ? LocalizeText('room.unmute.button.text')
                            : LocalizeText('room.mute.button.text')
                    }
