            ...
            <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-2">
                    ...
                    <Slider
                        ...
                        value={executions}
                        onChange={(value) =>
                            setExecutions(normalizeExecutions(Array.isArray(value) ? value[0] : Number(value)))
                        }
                    />
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Slider
                        ...
                        value={timeWindowMs}
                        onChange={(value) =>
                            setTimeWindowMs(normalizeTimeWindow(Array.isArray(value) ? value[0] : Number(value)))
                        }
                    />
