            ...
            <NitroCardContentView>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="w-12 text-[11px] text-black/70">
                        ...
                        <input
                            ...
                            className="grow"
                        />
                        <span className="w-12 text-right text-[11px] tabular-nums text-black/70">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <label className="flex flex-col gap-0.5 text-[11px] text-black/70">
                            ...
                            <input
                                type="number"
                                value={z}
                                onChange={(e) => setZ(e.target.valueAsNumber || 0)}
                                className="form-control form-control-sm"
                            />
                        </label>
                    </div>
