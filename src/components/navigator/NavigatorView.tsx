...
export const NavigatorView: FC<{}> = (props) => {
    ...
    useEffect(() => {
        LegacyExternalInterface.addCallback(HabboWebTools.OPENROOM, (k: string) =>
                        ...
                        {topLevelContexts &&
                            ...
                            topLevelContexts.map((context, index) => (
                                <NitroCard.TabItem
                                    ...
                                    isActive={
                                        (currentTabCode
                                            ? currentTabCode === context.code
                                            : topLevelContext === context) && !isCreatorOpen
                                    }
                                ...
                                <div className="flex flex-col w-full min-h-0 overflow-hidden gap-2">
                                    ...
                                    <Flex className="nitro-card-divider pt-2 border-t gap-2">
                                        <Flex
                                            ...
                                            style={{
                                                backgroundImage: `url(${createRoomImg})`,
                                        ...
                                        {searchResult?.code !== 'myworld_view' &&
                                            searchResult?.code !== 'roomads_view' && (
                                                <Flex
                                                    pointer
                                                    alignItems="center"
                                                    justifyContent="center"
                                                    className="flex-1 h-[60px] cursor-pointer bg-no-repeat pl-16"
                                                    style={{
                                                        backgroundImage: `url(${randomRoomImg})`,
                                                        backgroundSize: '100% 100%',
                                                    }}
                                                    onClick={() =>
                                        ...
                                        {(searchResult?.code === 'myworld_view' ||
                                            ...
                                            <Flex
                                                ...
                                                className="flex-1 h-[60px] cursor-pointer bg-no-repeat pl-16"
                                                style={{
                                                    backgroundImage: `url(${promoteRoomImg})`,
                                                    backgroundSize: '100% 100%',
                                                }}
