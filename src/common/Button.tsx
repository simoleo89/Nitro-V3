...
export const Button: FC<ButtonProps> = props =>
{
    ...
    const getClassNames = useMemo(() =>
    {
        ...
        {
            if(variant == 'primary')
                newClassNames.push('text-white bg-[var(--theme-primary,#1e7295)] border-[var(--theme-primary,#1e7295)] [box-shadow:inset_0_2px_#ffffff26,inset_0_-2px_#0000001a,0_1px_#0000001a] hover:text-white hover:bg-[var(--theme-primary-hover,#1a617f)] hover:border-[var(--theme-primary-border,#185b77)]');
            ...
            if(variant == 'dark')
                newClassNames.push('text-white bg-[var(--theme-dark-bg,rgba(28,28,32,.98))] border-[var(--theme-dark-border,rgba(28,28,32,.98))] [box-shadow:inset_0_2px_#ffffff26,inset_0_-2px_#0000001a,0_1px_#0000001a] hover:text-white');
