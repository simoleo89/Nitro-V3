...
export class AvatarEditorThumbnailsHelper {
    ...
    private static getThumbnailKey(
        setType: string,
    ...
    public static async build(
        ...
        if (!setType || !setType.length || !part || !part.partSet || !part.partSet.parts || !part.partSet.parts.length)
            return null;
    ...
    private static findOpaqueBoundsFrame(
        sprite: NitroSprite,
