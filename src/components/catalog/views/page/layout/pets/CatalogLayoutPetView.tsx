                ...
                <div className="flex flex-col flex-1 justify-between min-w-0">
                    <div>
                        ...
                        {!!page.localization.getText(0) && (
                            <p
                                className="text-[10px] text-dark mt-0.5"
                    ...
                    <div className="flex flex-col gap-1 mt-2">
                        <label className="text-[9px] text-dark uppercase font-bold">
            ...
            <div className="flex-1 overflow-auto min-h-0">
                <div className="flex items-center gap-1.5 mb-1.5">
                    <span className="text-[10px] font-bold text-dark uppercase tracking-wide">
                        {colorsShowing
                            ? LocalizeText('catalog.pets.choose.color')
                            : LocalizeText('catalog.pets.choose.breed')}
                    </span>
                    {colorsShowing && (
                        <button
                ...
                <div
                    className={
                        colorsShowing
                            ? 'nitro-catalog-classic-color-swatches flex flex-wrap gap-1 p-2 overflow-auto'
                            : 'nitro-catalog-classic-pet-breeds flex flex-wrap gap-1 p-1 overflow-auto'
                    }
                >
                    {!colorsShowing &&
