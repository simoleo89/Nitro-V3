...
const CATEGORIES: EarningCategory[] = [
    {
        key: 'daily_gift',
        textKey: 'earnings.dailygift.label',
        label: 'Regalo giornaliero',
        img: imgDailygift,
        fallbackCurrencies: [5],
    },
    { key: 'games', textKey: 'earnings.games.label', label: 'Giochi', img: imgGames, fallbackCurrencies: [0] },
    {
        key: 'achievements',
        textKey: 'earnings.achievements.label',
        label: 'Traguardi',
        img: imgAchievements,
        fallbackCurrencies: [5, 0],
    },
    {
        key: 'marketplace',
        textKey: 'earnings.marketplace.label',
        label: 'Mercatino',
        img: imgMarketplace,
    ...
    {
        key: 'hc_payday',
        textKey: 'earnings.hc.label',
        label: 'Bonus giorno di paga HC',
        img: imgHcpayday,
        fallbackCurrencies: [0],
    },
    {
        key: 'level_progress',
        textKey: 'earnings.levelprogression.label',
        label: 'Progressione Livello',
        img: imgLevel,
        fallbackCurrencies: [5, 0],
    },
    {
        key: 'donations',
        textKey: 'earnings.donations.label',
        label: 'Donazioni',
        img: imgDonations,
        fallbackCurrencies: [0],
    },
    {
        key: 'bonus_bag',
        textKey: 'earnings.bonusbag.label',
        label: 'Sacco Bonus',
        img: imgBonusbag,
        fallbackCurrencies: [0],
    },
    {
        key: 'mystery_boxes',
        textKey: 'earnings.surpriseboxes.label',
        label: 'Scatole Sorprese',
        img: imgSurprise,
        fallbackCurrencies: [5, 0],
    },
    {
        key: 'club_job',
        textKey: 'earnings.clubwork.label',
        label: 'Club e Lavoro',
        img: imgGeneric,
        fallbackCurrencies: [0],
    },
...
export const VaultView: FC<{}> = (props) => {
    ...
    return (
        <NitroCardView className="nitro-vault w-[430px]" theme="primary-slim" uniqueKey="vault">
            <NitroCardHeaderView
                headerText={localizeWithFallback('earnings.title', 'Guadagni')}
                            ...
                            <div className="flex min-w-0 flex-1 items-center gap-2 rounded-[5px] border border-[#9aa0a8] bg-white px-1.5 py-1">
                                <span className="flex h-[24px] w-[24px] shrink-0 items-center justify-center rounded border border-black/15 bg-white">
                                    <img
                                        src={category.img}
                                        alt=""
                                        className="max-h-[20px] max-w-[20px] object-contain [image-rendering:pixelated]"
                                    />
                                </span>
