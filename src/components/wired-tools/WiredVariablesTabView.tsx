            ...
            <div className="min-w-0 grow flex flex-col gap-3">
                {variablesType === 'context' && (
                    <div className="rounded border border-[#c8b98f] bg-[#fff7df] px-3 py-2 text-[12px] text-[#6a5d33]">
                        Context variables live only during the current wired execution. This tab shows their
                        definitions, text mappings and execution-scoped capabilities, but not live values from a running
                        stack.
                    </div>
                )}
                <div className="flex flex-col gap-1">
