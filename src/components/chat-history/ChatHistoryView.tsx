    ...
    return (
        <NitroCardView className="w-[400px] h-[400px] bg-[#f0f0f0]" theme="primary-slim" uniqueKey="chat-history">
            ...
            <NitroCardTabsView>
                ...
                <NitroCardTabsItemView
                    count={unreadCount}
                    isActive={activeTab === TAB_MENTIONS}
            ...
            <NitroCardContentView
                className="h-full bg-[#f0f0f0] bg-[url('@/assets/images/chat/chathistory_background.png')] bg-repeat bg-auto"
                gap={2}
                overflow="hidden"
