            ...
            <Column style={{ width: 40, height: 40 }}>
                <LayoutGridItem
                    ...
                    itemImage={GetImageIconUrlForProduct(
                        offerData.furniType === MarketplaceOfferData.TYPE_FLOOR
                            ? ProductTypeEnum.FLOOR
                            : ProductTypeEnum.WALL,
                        offerData.furniId,
                        offerData.extraData,
                    )}
            ...
            <Column grow gap={0}>
                ...
                {type === OWN_OFFER && (
                    <>
                        <Text>
                            {LocalizeText(
                                'catalog.marketplace.offer.price_own_item',
                                ['price'],
                    ...
                    <>
                        <Text>
                            {LocalizeText(
                                ...
                                [
                                    offerData.price.toString(),
                                    offerData.averagePrice > 0 ? offerData.averagePrice.toString() : '-',
                                ],
                            )}
                        </Text>
                        <Text>
                            {LocalizeText(
                                'catalog.marketplace.offer_count',
                                ['count'],
                                [offerData.offerCount.toString()],
                            )}
                        </Text>
                    </>
                )}
