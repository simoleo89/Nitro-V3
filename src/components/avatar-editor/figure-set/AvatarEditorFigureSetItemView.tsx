...
> = (props) => {
    ...
    useEffect(() => {
        ...
        const loadImage = async () => {
            ...
            if (setType === 'hd') {
                url = await AvatarEditorThumbnailsHelper.buildForFace(
                    getFigureStringWithFace(partItem.id),
    ...
    return (
        <InfiniteGrid.Item
            ...
            style={
                isHead
                    ? { backgroundSize: 'auto 80%', backgroundPosition: 'center', imageRendering: 'pixelated' }
                    : undefined
            }
            {...rest}
        >
