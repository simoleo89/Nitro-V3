...
export const Slider: FC<SliderProps> = (props) => {
    ...
    return (
        <Flex fullWidth gap={1} classNames={['nitro-slider-wrapper']}>
            {!disabledButton && (
                <Button
                    classNames={['nitro-slider-button', 'nitro-slider-button-left']}
                    disabled={disabled || minimum >= currentValue}
                    onClick={stepDown}
                >
                    <FaAngleLeft />
                </Button>
            ...
            {!disabledButton && (
                <Button
                    classNames={['nitro-slider-button', 'nitro-slider-button-right']}
                    disabled={disabled || maximum <= currentValue}
                    onClick={stepUp}
                >
                    <FaAngleRight />
                </Button>
