...
export const CatalogAdminOfferEditView: FC<{}> = () => {
    ...
    const inputClass =
        'text-[11px] border-2 border-card-grid-item-border rounded px-2 py-1 bg-white placeholder:text-[#4b5563] focus:outline-none focus:border-primary transition-colors';
    ...
    return createPortal(
        ...
        >
            ...
            <div
                className="nitro-card-shell relative w-[420px] overflow-hidden shadow-lg"
            ...
            >
                ...
                <div className="nitro-card-header-shell flex items-center justify-between px-3 py-2">
                    <span className="text-sm font-bold text-white">
                        {isNew
                            ...
                            : `${LocalizeText('catalog.admin.offer.edit')} #${editingOffer.offerId}`}
                    </span>
                ...
                <div className="p-3 flex flex-col gap-2.5">
                    ...
                    <div className="flex flex-col gap-0.5">
                        <label className="text-[9px] text-primary uppercase font-bold">
                            {LocalizeText('catalog.admin.offer.name')}
                        </label>
                        <input
                    ...
                    <div className="bg-white rounded border-2 border-card-grid-item-border p-2.5">
                        <div className="text-[9px] text-primary uppercase font-bold mb-1.5">
                        ...
                        <div className="grid grid-cols-3 gap-1.5">
                            ...
                            <div className="flex flex-col gap-0.5">
                                <label className="text-[9px] text-muted">
                                    {LocalizeText('catalog.admin.offer.quantity')}
                                </label>
                                <input
                                    className={inputClass}
                                    min={1}
                    ...
                    <div className="bg-white rounded border-2 border-card-grid-item-border p-2.5">
                        ...
                        <div className="grid grid-cols-3 gap-1.5">
                            <div className="flex flex-col gap-0.5">
                                <label className="text-[9px] text-muted">
                                    {LocalizeText('catalog.admin.offer.credits')}
                                </label>
                                <input
                                    className={inputClass}
                                    min={0}
                            ...
                            <div className="flex flex-col gap-0.5">
                                <label className="text-[9px] text-muted">
                                    {LocalizeText('catalog.admin.offer.points')}
                                </label>
                                <input
                                    className={inputClass}
                                    min={0}
                            ...
                            <div className="flex flex-col gap-0.5">
                                <label className="text-[9px] text-muted">
                                    {LocalizeText('catalog.admin.offer.points.type')}
                                </label>
                                <select
                                    className={inputClass}
                                    value={pointsType}
                    ...
                    <div className="bg-white rounded border-2 border-card-grid-item-border p-2.5">
                        ...
                        <div className="grid grid-cols-3 gap-1.5 mb-1.5">
                            <div className="flex flex-col gap-0.5">
                                <label className="text-[9px] text-muted">
                                    {LocalizeText('catalog.admin.offer.club.only')}
                                </label>
                                <select
                                    className={inputClass}
                                    value={clubOnly}
                        ...
                        <div className="flex flex-col gap-0.5">
                            <label className="text-[9px] text-muted">
                                {LocalizeText('catalog.admin.offer.extradata')}
                            </label>
                            <input
                                className={inputClass}
                        ...
                        <div className="flex items-center gap-1.5 mt-1.5">
                            ...
                            />
                            <label className="text-[10px] cursor-pointer" htmlFor="haveOffer">
                    ...
                    <div className="flex justify-between">
                        {!isNew ? (
                            <button
                                className="flex items-center gap-1 px-2 py-1 rounded text-[10px] font-bold bg-danger/10 text-danger border border-danger/30 hover:bg-danger/20 transition-colors cursor-pointer"
                        ...
                        <button
                            className="flex items-center gap-1 px-3 py-1 rounded text-[10px] font-bold bg-primary text-white hover:bg-secondary transition-colors cursor-pointer disabled:opacity-50"
                            disabled={loading}
                            onClick={handleSave}
                        >
                            {loading ? (
