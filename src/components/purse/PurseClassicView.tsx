...
export const PurseClassicView: FC = (props) => {
    ...
    const currencyDisplayNumberShort = useMemo(
        () => GetConfigurationValue<boolean>('currency.display.number.short', false),
        [],
    );
            ...
            <div className="nitro-purse-classic">
                <div className={`nitro-purse-shell ${isCompact ? 'is-closed' : ''}`}>
                    <div className={`nitro-purse ${isCompact ? 'is-closed' : ''}`}>
                        <div
                            className={`nitro-purse__header ${isCompact ? 'is-closed' : ''}`}
                        ...
                        >
                            <Flex
                                ...
                                gap={1}
                                className={
                                    isCompact ? 'nitro-purse__header-main is-closed' : 'nitro-purse__header-main'
                                }
                            >
                        ...
                        <div className={`nitro-purse__content ${isOpen ? 'is-open' : 'is-closed'}`}>
                            <div
                                className={`nitro-purse__summary nitro-purse__summary--compact ${hcDisabled ? 'is-no-hc' : ''}`}
                            >
                                <div className="nitro-purse__primary">
                                    ...
                                    {primaryCurrencies.map((type) => (
                                        <CurrencyView
                                            key={type}
                                            type={type}
                                            amount={purse.activityPoints.get(type) || 0}
                                ...
                                {!hcDisabled && (
                                    <div
                                        ...
                                        onClick={(event) => {
                                            ...
                                            CreateLinkEvent(
                                                'catalog/open/' +
                                                    GetConfigurationValue<Record<string, string>>('catalog.links')?.[
                                                        'hc.buy_hc'
                                                    ],
                                            );
                                        }}
                                    >
                                        ...
                                        <div className="nitro-purse-subscription__copy">
                                            <Text variant="white" className="nitro-purse-subscription__label">
                                                HC
                                            </Text>
                                            <Text variant="white" className="nitro-purse-subscription__value">
                                                {getClubText}
                                            </Text>
                                        </div>
                                    </div>
                                ...
                                <div className="nitro-purse__actions">
                                    <button
                                        type="button"
                                        className="nitro-purse__action-button nitro-purse__action-button--translate"
                                        onClick={(event) => {
                                            event.stopPropagation();
                                    ...
                                    <button
                                        type="button"
                                        className="nitro-purse__action-button nitro-purse__action-button--help"
                                        onClick={(event) => {
                                            event.stopPropagation();
                                    ...
                                    <button
                                        type="button"
                                        className="nitro-purse__action-button nitro-purse__action-button--settings"
                                        onClick={(event) => {
                                            event.stopPropagation();
                                    ...
                                    <button
                                        type="button"
                                        className="nitro-purse__action-button nitro-purse__action-button--logout"
