                    ...
                    {isFurni && (
                        <Flex gap={1} style={{ margin: '4px 0' }}>
                                ...
                                {furniEntries.length === 0 ? (
                                    ...
                                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
                                        {furniEntries.map((f) => (
                                            ...
                                            >
                                                <LayoutFurniImageView productType="s" productClassId={f.baseItemId} />
                                                <div
                                                    style={{
                                                        position: 'absolute',
                                                        right: 1,
                            ...
                            <div style={{ width: 175, display: 'flex', flexDirection: 'column' }}>
                                <div style={{ flex: 1, minHeight: 211, border: '1px solid #d8d8d8', borderRadius: 3, background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 6 }}>
                                    {selectedFurni >= 0 ? (
                                        <>
