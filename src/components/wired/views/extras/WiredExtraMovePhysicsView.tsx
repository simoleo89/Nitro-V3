...
const normalizeSource = (value: number, options: WiredSourceOption[]) =>
...
export const WiredExtraMovePhysicsView: FC<{}> = () => {
    ...
    const footer = useMemo(() => {
        ...
        blockByFurniSource,
        moveThroughFurni,
        moveThroughFurniSource,
        moveThroughUsers,
        moveThroughUsersSource,
    ]);
        ...
        >
            <div className="flex flex-col gap-2">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                    <input
                        checked={keepAltitude}
                        className="form-check-input"
                        type="checkbox"
                        onChange={(event) => setKeepAltitude(event.target.checked)}
                    />
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                    <input
                        checked={blockByFurni}
                        className="form-check-input"
                        type="checkbox"
                        onChange={(event) => setBlockByFurni(event.target.checked)}
                    />
