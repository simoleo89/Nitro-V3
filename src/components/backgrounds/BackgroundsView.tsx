...
type RemoteData = Partial<
    Record<'backgrounds.data' | 'stands.data' | 'overlays.data' | 'cards.data' | 'borders.data', any[]>
>;
...
export const BackgroundsView: FC<BackgroundsViewProps> = ({
    ...
    const allData = useMemo(
        () => ({
            ...
            cards: processData(
                readData('cards.data').length ? readData('cards.data') : readData('backgrounds.data'),
                'backgroundId',
            ),
    ...
    const handleSelection = useCallback(
        (id: number) => {
            ...
            roomSession.sendBackgroundMessage(
                newValues.backgrounds,
                newValues.stands,
                newValues.overlays,
                newValues.cards,
                newValues.borders,
    ...
    return (
        <NitroCardView
            uniqueKey="backgrounds"
            className="absolute min-w-[535px] max-w-[535px] min-h-[389px] max-h-[389px]"
        >
