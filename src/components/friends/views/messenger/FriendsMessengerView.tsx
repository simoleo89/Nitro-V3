...
export const FriendsMessengerView: FC = (props) => {
    ...
    const followFriend = () =>
        ...
        SendMessageComposer(new FollowFriendMessageComposer(activeThread.participant.id));
                        ...
                        <>
                            <div className="messenger-thread-header">
                                ...
                                <div className="messenger-actions">
                                            ...
                                            <button
                                                ...
                                                onClick={() =>
                                                    report(ReportType.IM, {
                                                        reportedUserId: activeThread.participant.id,
                                                    })
                                                }
                                            >
                                    ...
                                    <button
                                        className="messenger-btn close-btn"
