...
const NitroCardHeader = ({
    ref,
    headerText = '',
    onCloseClick = null,
    className = null,
    ...rest
}: NitroCardHeaderProps) => {
...
const NitroCardContent = ({
    ref,
    isLoading = false,
    className = null,
    children = null,
    ...rest
}: NitroCardContentProps) => {
    return (
        <div
            ref={ref}
            className={classNames('nitro-card-content-shell flex flex-col overflow-auto p-[10px] h-full', className)}
            {...rest}
        >
