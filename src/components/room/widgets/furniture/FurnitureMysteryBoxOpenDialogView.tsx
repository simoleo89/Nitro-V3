            ...
            <NitroCardHeaderView
                headerText={
                    mode === ViewMode.WAITING
                        ? LocalizeText(`mysterybox.dialog.${isOwner ? 'owner' : 'other'}.title`)
                        : LocalizeText('mysterybox.reward.title')
                }
                onCloseClick={close}
            />
                ...
                {mode === ViewMode.WAITING && (
                    <>
                        <Text variant="primary">
                            {' '}
                            {LocalizeText(`mysterybox.dialog.${isOwner ? 'owner' : 'other'}.subtitle`)}{' '}
                        </Text>
                ...
                {mode === ViewMode.PRIZE && prizeData && (
                    <>
                        ...
                        <Flex className="prize-container justify-center mx-auto">
                            <LayoutPrizeProductImageView
                                classId={prizeData.classId}
                                productType={prizeData.contentType}
                            />
                        </Flex>
