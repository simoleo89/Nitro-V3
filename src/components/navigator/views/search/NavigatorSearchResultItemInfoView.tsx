                        ...
                        <Flex gap={1} overflow="hidden" className="p-2">
                            ...
                            >
                                {roomData.habboGroupId > 0 && (
                                    <LayoutBadgeImageView
                                        ...
                                        className="absolute top-0 inset-s-0 m-1"
                                        isGroup={true}
                                    />
                                )}
                            ...
                            <Column gap={1}>
                                <Text bold className="grow" style={{ maxHeight: 13 }}>
                                    {roomData.roomName.length > 35
                                        ? roomData.roomName.substring(0, 35) + '…'
                                        : roomData.roomName}
                                </Text>
                            ...
                            <Flex alignItems="center" className="mb-2">
                                {roomData.ownerName && roomData.ownerName.length > 0 && (
                                    <Flex
                                        ...
                                        gap={1}
                                        className="w-1/2 items-center cursor-pointer"
                                    >
                            ...
                            <Flex gap={4} className="w-full">
                                <Column className="w-3/5" gap={1}>
                                    ...
                                    <Flex gap={1} alignItems="center">
                                        <Flex
                                            center
                                            className={
                                                'rounded px-1 py-0.5 text-xs font-bold text-white ' +
                                                getUserCounterColor()
                                            }
                                            gap={1}
                                        >
                                ...
                                <Column alignItems="start" gap={2} className="w-2/5">
                                    ...
                                    >
                                        <i
                                            className={classNames(
                                                'icon icon-navigator-favorite-room',
                                                isFavourite ? 'active' : '',
                                            )}
                                        />
                                        <Text className="text-xs">
                                            {LocalizeText('navigator.room.popup.room.info.favorite')}
                                        </Text>
                                    </Flex>
                                    <Flex
                                        pointer
                                    ...
                                    >
                                        <i
                                            className={classNames(
                                                'icon icon-navigator-my-room',
                                                navigatorData?.homeRoomId !== roomData.roomId ? '' : 'active',
                                            )}
                                        />
                                        <Text className="text-xs">
                                            {LocalizeText('navigator.room.popup.room.info.home')}
                                        </Text>
                                    </Flex>
                                    ...
                                    {GetSessionDataManager().userId !== roomData.ownerId && (
                                        ...
                                        >
                                            ...
                                            <Text className="text-xs">
                                                {LocalizeText('navigator.room.popup.report.room')}
                                            </Text>
                                        </Flex>
                                    )}
                                </Column>
