...
export const WiredActionFurniAreaView: FC = (props) => {
    ...
    useEffect(() => {
        ...
        const activated = GetRoomEngine().areaSelectionManager.activate(
            callback,
            RoomAreaSelectionManager.HIGHLIGHT_BRIGHTEN,
        );
    ...
    const pickedCount = hasArea
        ? GetRoomEngine()
              ...
              .filter((obj) => {
                  ...
                  const inArea =
                      loc.x >= rootX && loc.x < rootX + areaWidth && loc.y >= rootY && loc.y < rootY + areaHeight;
            ...
            <div className="flex flex-col gap-2">
                ...
                {hasArea && (
                    <Text small>
                        {LocalizeText(
                            ...
                            ['count', 'limit'],
                            [pickedCount.toString(), pickedLimit.toString()],
                        )}
                    </Text>
                )}
                ...
                <div className="flex gap-1">
                    <Button
                        fullWidth
                        variant="primary"
                        onClick={() => GetRoomEngine().areaSelectionManager.startSelecting()}
                    >
