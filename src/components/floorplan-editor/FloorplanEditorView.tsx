...
export const FloorplanEditorView: FC = () => {
    ...
    const {
        setBaseline,
        mergeBaseline,
        revert: revertLivePreview,
    } = useFloorplanLiveSync({ enabled: liveSync && isVisible, state });
                ...
                <NitroCardView uniqueKey="floorpan-editor" className="w-[820px] h-[620px]" theme="primary-slim">
                    ...
                    <NitroCardContentView overflow="hidden" className="flex flex-col gap-2">
                        ...
                        <Flex gap={2} className="flex-1 min-h-0">
                            <FloorplanHeightPicker
                                selectedH={state.brush.h}
                                onSelect={(h) => dispatch({ type: 'BRUSH_SET', h })}
                            />
                        ...
                        <Flex gap={3} alignItems="center" className="px-1">
                            <Flex gap={1} alignItems="center">
                                ...
                                <FaCaretLeft
                                    className="cursor-pointer fa-icon text-zinc-600"
                                    onClick={() => onWallHeightChange(state.wallHeight - 1)}
                                />
                                <input
                                    type="number"
                        ...
                        <Flex justifyContent="between">
                            ...
                            <ButtonGroup>
                                <Button onClick={() => setImportExportVisible(true)}>
