...
export const GroupCreatorView: FC<GroupCreatorViewProps> = (props) => {
    ...
    return (
        <NitroCardView
            className="h-[355px] w-[390px] border border-[solid] border-[#283F5D]        "
            theme="primary-slim"
        >
            ...
            <NitroCardContentView>
                ...
                <Column overflow="hidden">
                    ...
                    <Column overflow="hidden">
                        ...
                        {currentTab === 4 && (
                            <GroupTabCreatorConfirmationView
                                groupData={groupData}
                    ...
                    <div className="flex justify-between">
                        ...
                        >
                            {LocalizeText(
                                currentTab === 4
                                    ? HasHabboClub()
                                        ? 'group.create.confirm.buy'
                                        : 'group.create.confirm.viprequired'
                                    : 'group.create.nextstep',
                            )}
                        </Button>
                    </div>
                </Column>
