        ...
        switch (selectedIndex) {
            ...
            case 4:
                return symbols.filter((item) => {
                    ...
                    return !names.some(
                        (name) => name.includes('_part1') || name.includes('_part2') || isAlphaNumericSymbol(name),
                    );
                });
            default:
                return symbols;
                        ...
                        >
                            ...
                            >
                                ...
                                {(!badgeParts[index].code || !badgeParts[index].code.length) && (
                                    <Flex
                                        center
                                        className="relative w-[40px] h-[40px] bg-no-repeat bg-center group-badge"
                                    >
                ...
                <Grid columnCount={5} gap={1}>
                    {badgeParts[selectedIndex].type === GroupBadgePart.SYMBOL && (
                        <Column
                            ...
                            pointer
                            className="bg-muted rounded p-1"
                            onClick={(event) => setPartProperty(selectedIndex, 'key', 0)}
                        >
                        ...
                        return (
                            ...
                            >
                                <LayoutBadgeImageView
                                    badgeCode={GroupBadgePart.getCode(
                                        badgeParts[selectedIndex].type,
                                        item.id,
                                        badgeParts[selectedIndex].color,
                                        4,
                                    )}
                                    isGroup={true}
                                />
