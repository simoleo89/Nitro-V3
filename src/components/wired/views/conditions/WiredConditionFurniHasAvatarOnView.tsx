...
export const WiredConditionFurniHasAvatarOnView: FC<WiredConditionFurniHasAvatarOnViewProps> = ({
    negative = false,
}) => {
            ...
            <div className="flex flex-col gap-1">
                ...
                {[0, 1].map((value) => (
                    <label key={value} className="flex items-center gap-1">
                        ...
                        <Text>
                            {LocalizeText(
                                `wiredfurni.params.${negative ? 'not_requireall' : 'requireall'}.${value + 2}`,
                            )}
                        </Text>
                    </label>
                ))}
