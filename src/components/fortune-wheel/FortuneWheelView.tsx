...
export const FortuneWheelView: FC<{}> = () => {
    ...
    const background = useMemo(() => {
        ...
        const stops = prizes
            .map((_, i) => `${SLICE_COLORS[i % 2]} ${i * sliceAngle}deg ${(i + 1) * sliceAngle}deg`)
            .join(', ');
                    ...
                    <Flex gap={3} className="flex-col sm:flex-row">
                        <Column alignItems="center" gap={2} className="w-full shrink-0 sm:w-[420px]">
                            <div
                                ...
                                style={{ height: WHEEL_SIZE * wheelScale }}
                            >
                                <div
                                        ...
                                        {prizes.map((prize, i) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={{
                                                        transform: `rotate(${centerAngle}deg) translateY(-${ICON_RADIUS}px) rotate(-${centerAngle}deg)`,
                                                    }}
                                                >
                            ...
                            <Column gap={1} overflow="auto" className="h-[440px] max-h-[60vh]">
                                {recentWins.map((win, i) => (
                                    <Flex
                                        ...
                                        alignItems="center"
                                        gap={2}
                                        className="rounded border-b border-black/10 py-1.5 hover:bg-black/5"
                                    >
