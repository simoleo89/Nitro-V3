                ...
                <div className="nitro-purse__body">
                    <div className="nitro-purse__currencies">
                        {hasDiamonds && (
                            <CurrencyView
                                type={5}
                                amount={purse.activityPoints.get(5) || 0}
                        ...
                        {hasDuckets && (
                            <CurrencyView
                                type={0}
                                amount={purse.activityPoints.get(0) || 0}
                                short={currencyDisplayNumberShort}
                            />
                        )}
                    </div>
                    <div className="nitro-purse__col nitro-purse__col--primary">
                        ...
                        <button
                            type="button"
                            className="nitro-purse__btn nitro-purse__btn--earnings"
            ...
            {settingsMenuOpen && (
                <div className="nitro-purse-menu">
                    <button
                        ...
                        onClick={() => openSettingsSection('audio')}
                    >
                        Impostazioni Audio
                    </button>
                    <button
                    ...
                    <button
                        type="button"
                        className="nitro-purse-menu__item"
                        onClick={() => openSettingsSection('chat')}
                    >
                        Impostazioni Chat
                    </button>
                    <button
                        type="button"
                        className="nitro-purse-menu__item"
                        onClick={() => openSettingsSection('other')}
                    >
                        Altre Impostazioni
                    </button>
                    <button
