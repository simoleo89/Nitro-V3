            ...
            >
                ...
                >
                    <svg className="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path
                            ...
                            strokeWidth={3}
                            d={leftCollapsed ? 'M9 5l7 7-7 7' : 'M15 19l-7-7 7-7'}
                        />
                    </svg>
                </button>
                <motion.div
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="relative">
                        ...
                        >
                            <LayoutAvatarImageView
                                ...
                                figure={userFigure}
                                className="tb-icon"
                                style={{ backgroundSize: 'auto', backgroundPosition: '-25px -38px' }}
                            />
                        </motion.div>
                        {getTotalUnseen > 0 && (
                            <LayoutItemCountView
                    ...
                    <motion.div variants={itemVariants}>
                        <ToolbarItemView
                            icon="buildersclub"
                            onClick={() => CreateLinkEvent('catalog/toggle/builder')}
                            className="tb-icon"
                        />
                    </motion.div>
                    <motion.div variants={itemVariants} className="relative">
                    ...
                    {!leftCollapsed && (
                        <>
                            <motion.div variants={itemVariants}>
                                <ToolbarItemView
                                    icon="rare-values"
                                    onClick={() => CreateLinkEvent('rare-values/toggle')}
                                    className="tb-icon"
                                />
                            </motion.div>
                            <motion.div variants={itemVariants}>
                                <ToolbarItemView
                                    icon="fortune-wheel"
                                    onClick={() => CreateLinkEvent('fortune-wheel/toggle')}
                                    className="tb-icon"
                                />
                            </motion.div>
                        ...
                        <>
                            ...
                            {isInRoom && soundboardEnabled && (
                                <motion.div variants={itemVariants}>
                                    <ToolbarItemView
                                        icon="soundboard"
                                        onClick={() => CreateLinkEvent('soundboard/toggle')}
                                        className="tb-icon"
                                    />
                                </motion.div>
                            )}
                    ...
                    {isHk && hkEnabled && (
                        <motion.div variants={itemVariants}>
                            <ToolbarItemView
                                icon="housekeeping"
                                onClick={() => CreateLinkEvent('housekeeping/toggle')}
                                className="tb-icon"
                            />
                        </motion.div>
                    )}
                    {isMod && (
                        <motion.div variants={itemVariants}>
                            <ToolbarItemView
                                icon="furnieditor"
                                onClick={() => CreateLinkEvent('furni-editor/toggle')}
                                className="tb-icon"
                            />
                        </motion.div>
                    )}
                        ...
                        <>
                            {mentionsEnabled && (
                                <motion.div variants={itemVariants} className="relative">
                                    <ToolbarItemView
                                        icon="mentions"
                                        onClick={() => CreateLinkEvent('mentions/toggle')}
                                        className="tb-icon"
                                    />
                                    {mentionsUnread > 0 && (
                                        <LayoutItemCountView
                            ...
                            <div
                                className={`h-full shrink-0 ${desktopBlockClasses}`}
                                id="toolbar-friend-bar-container-desktop"
                            />
                        </>
                    )}
                </motion.div>
                ...
                >
                    <svg className="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={3}
                            d={rightCollapsed ? 'M15 19l-7-7 7-7' : 'M9 5l7 7-7 7'}
                        />
                    </svg>
                </button>
            </motion.div>
