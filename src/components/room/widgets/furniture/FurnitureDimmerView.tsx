...
export const FurnitureDimmerView: FC = (props) => {
    ...
    useNitroEvent<RoomEngineTriggerWidgetEvent>(RoomEngineTriggerWidgetEvent.REMOVE_DIMMER, (event) =>
        setIsVisible(false),
    );
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <Slider
                                ...
                                renderThumb={(props, state) => (
                                    <div {...props}>{FurnitureDimmerUtilities.scaleBrightness(state.valueNow)}</div>
                                )}
