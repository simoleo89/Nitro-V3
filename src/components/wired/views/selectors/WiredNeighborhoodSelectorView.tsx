...
const NeighborhoodGrid: FC<NeighborhoodGridProps> = (props) => {
    ...
    return (
        <div
            style={{ position: 'relative', width: GRID_PX_W, height: GRID_PX_H, flexShrink: 0 }}
...
export const WiredNeighborhoodSelectorView: FC<{}> = () => {
    ...
    const activeSources = useMemo(
        () => (sourceType <= SOURCE_USER_CLICKED ? availableUserSources : FURNI_SOURCES),
        [availableUserSources, sourceType],
    );
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <Button
                        ...
                        className="px-2 py-1"
                        onClick={addTile}
                        title={LocalizeText('wiredfurni.tooltip.select.tile')}
                    >
                        <FaPlus />
                    </Button>
                    <Button
                        ...
                        className="px-2 py-1"
                        onClick={removeTile}
                        title={LocalizeText('wiredfurni.tooltip.remove.tile')}
                    >
                        <FaMinus />
                    </Button>
                    <Button
                        variant="primary"
                        className="px-2 py-1"
                        onClick={loadDefaultPattern}
                        title={LocalizeText('wiredfurni.tooltip.remove.5x5_tile')}
                    >
                        <MdGridOn />
                    </Button>
                    <Button
