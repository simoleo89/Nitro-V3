...
export const NitroSystemAlertView: FC<NotificationDefaultAlertViewProps> = (props) => {
    ...
    return (
        <LayoutNotificationAlertView
            title={title}
            onClose={onClose}
            classNames={['nitro-alert-system', ...classNames]}
            {...rest}
        >
            <Grid>
                <Column size={12}>
                    ...
                    <Column alignItems="center">
                        ...
                        <Column fullWidth gap={1}>
                            <Button
                                fullWidth
                                variant="success"
                                onClick={(event) => window.open('https://discord.nitrodev.co')}
                            >
                                Discord
                            </Button>
                            {adsEnabled && (
                    ...
                    <Column size={12}>
                        <Column alignItems="center" gap={0}>
                            ...
                            <Button
                                fullWidth
                                onClick={(event) => window.open('https://github.com/duckietm/Nitro-Cool-UI')}
                            >
                                Cool UI Git
                            </Button>
                        </Column>
