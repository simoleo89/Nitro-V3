                    ...
                    <NitroCardHeaderView
                        ...
                        headerText={
                            objectType === 'gnome_box'
                                ...
                                : LocalizeText('furni.petpackage.open')
                        }
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-5 justify-center mt-2">
                                    ...
                                    <Button
                                        ...
                                        variant={petName.length < 3 ? 'danger' : 'success'}
                                        onClick={() => onConfirm()}
                                    >
                                        {objectType === 'gnome_box'
                                            ? LocalizeText('widgets.gnomepackage.name.pick')
                                            : LocalizeText('furni.petpackage.confirm')}
                                    </Button>
                                </div>
                            </div>
                        </div>
