...
export const FriendsSearchView: FC<FriendsSearchViewProps> = (props) => {
    ...
    const getSearchResultFigure = (result: HabboSearchResultData) => {
        ...
        const typedResult = result as HabboSearchResultData & {
            figureString?: string;
            avatarFigure?: string;
            figure?: string;
            avatarFigureString?: string;
        };

        return (
            typedResult.figureString ||
            typedResult.avatarFigure ||
            typedResult.figure ||
            typedResult.avatarFigureString ||
            null
        );
    };
                                ...
                                <Column gap={0}>
                                    {friendResults.map((result) => {
                                        return (
                                            <NitroCardAccordionItemView
                                                key={result.avatarId}
                                                className="friends-list-item px-2 py-1"
                                                    ...
                                                    <div className="friends-list-avatar">
                                                        <LayoutAvatarImageView
                                                            figure={resolveAvatarFigure(
                                                                getSearchResultFigure(result),
                                                                getSearchResultGender(result),
                                                            )}
