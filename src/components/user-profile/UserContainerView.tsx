        ...
        <div className="nitro-extended-profile">
            <div className="nitro-extended-profile__top">
                <div className="nitro-extended-profile__left">
                    <div className="nitro-extended-profile__identity">
                        <div
                            className={`nitro-extended-profile__avatar-shell profile-background ${infostandBackgroundClass}`}
                        >
                            <div
                                className={`nitro-extended-profile__avatar-stand profile-stand ${infostandStandClass}`}
                            />
                            <LayoutAvatarImageView
                                figure={userProfile.figure}
                                direction={2}
                                classNames={['nitro-extended-profile__avatar-image']}
                            />
                            <div
                                className={`nitro-extended-profile__avatar-overlay profile-overlay ${infostandOverlayClass}`}
                            />
                        </div>
                        <div className="nitro-extended-profile__identity-copy">
                            ...
                            <p className="nitro-extended-profile__meta">
                                <span
                                    dangerouslySetInnerHTML={{
                                        __html: SanitizeHtml(
                                            LocalizeText('extendedprofile.created').replace(/%\w+%/g, '').trim(),
                                        ),
                                    }}
                                />{' '}
                            ...
                            <p className="nitro-extended-profile__meta">
                                <span
                                    dangerouslySetInnerHTML={{
                                        __html: SanitizeHtml(
                                            LocalizeText('extendedprofile.last.login').replace(/%\w+%/g, '').trim(),
                                        ),
                                    }}
                                />{' '}
                    ...
                    {isOwnProfile && (
                        <div className="nitro-extended-profile__actions">
                            <button
                                className="nitro-extended-profile__link"
                                type="button"
                                onClick={() => CreateLinkEvent('avatar-editor/show')}
                            >
                            ...
                            <button
                                className="nitro-extended-profile__link"
                                type="button"
                                onClick={() => CreateLinkEvent('inventory/show/badges')}
                            >
                    ...
                    <div className="nitro-extended-profile__badges">
                        {[0, 1, 2, 3, 4].map((index) => (
                            <button key={index} className="nitro-extended-profile__badge-slot" type="button">
                                {selectedBadges[index] && (
                                    <LayoutBadgeImageView
                                        badgeCode={selectedBadges[index]}
                                        highlightRarity
                                        showInfo
                                        showRarityInfo
                                    />
                ...
                <div className="nitro-extended-profile__right">
                    ...
                    />
                    <p className="nitro-extended-profile__relationships-label">
            ...
            <div className="nitro-extended-profile__summary-bar">
                <button className="nitro-extended-profile__summary-button" type="button" onClick={onOpenRooms}>
                    ...
                    <span className="nitro-extended-profile__summary-label">
                ...
                >
                    <img
                        className="nitro-extended-profile__summary-icon nitro-extended-profile__summary-icon--badge"
                        src={badgeEmblemDefault}
                        alt=""
                    />
