...
const InlineNumberInput: FC<{ value: number; min: number; max: number; onChange: (value: number) => void }> = (
    props,
) => {
                            ...
                            return (
                                <label key={value} className="flex items-center gap-1">
                                    <input
                                        ...
                                        type="checkbox"
                                        onChange={(event) =>
                                            setWeekdayMask(toggleMaskValue(weekdayMask, value, event.target.checked))
                                        }
                                    />
                            ...
                            return (
                                <label key={value} className="flex items-center gap-1">
                                    <input
                                        ...
                                        type="checkbox"
                                        onChange={(event) =>
                                            setMonthMask(toggleMaskValue(monthMask, value, event.target.checked))
                                        }
                                    />
