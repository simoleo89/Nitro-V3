...
> = (props) => {
    ...
    return (
        ...
        >
            ...
            />
            <div
                className="navigation-item relative nitro-icon icon-me-clothing cursor-pointer"
            ...
            />
            <div
                className="navigation-item relative nitro-icon icon-me-settings cursor-pointer"
