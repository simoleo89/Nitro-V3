...
export const WiredConditionUserPerformsActionView: FC<WiredConditionUserPerformsActionViewProps> = (props) => {
    ...
    const quantifierKeyPrefix = negative
        ? 'wiredfurni.params.quantifier.users.neg'
        : 'wiredfurni.params.quantifier.users';
        ...
        <WiredConditionBaseView
            ...
            footer={
                <div className="flex flex-col gap-2">
                    ...
                    >
                        {LocalizeText(
                            showAdvanced ? 'wiredfurni.params.sources.collapse' : 'wiredfurni.params.sources.expand',
                        )}
                    </button>
                    {showAdvanced && (
                        <>
                            ...
                            <WiredSourcesSelector
                                ...
                                userSources={USER_ACTION_SOURCES}
                ...
                <div className="flex flex-col gap-1">
                    ...
                    {signFilterEnabled && (
                        <select
                            className="form-select form-select-sm"
                            value={signId}
                            onChange={(event) => setSignId(parseInt(event.target.value))}
                        >
                ...
                <div className="flex flex-col gap-1">
                    ...
                    {danceFilterEnabled && (
                        <select
                            className="form-select form-select-sm"
                            value={danceId}
                            onChange={(event) => setDanceId(parseInt(event.target.value))}
                        >
