...
export const InfoStandWidgetUserRelationshipsRelationshipItemView: FC<
    InfoStandWidgetUserRelationshipsRelationshipItemViewProps
> = (props) => {
            ...
            <Flex alignItems="center" gap={0}>
                <Text small variant="white" onClick={(event) => GetUserProfile(relationship.randomFriendId)}>
                    ...
                    {relationship.friendCount > 1 &&
                        ' ' +
                            LocalizeText(
                                `extendedprofile.relstatus.others.${relationshipName}`,
                                ['count'],
