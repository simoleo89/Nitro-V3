...
export const WiredActionRelativeMoveView: FC = () => {
    ...
    const save = () =>
        setIntParams([horizontalDirection, horizontalDistance, verticalDirection, verticalDistance, furniSource]);
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-2">
                ...
                <Text>
                    {LocalizeText(
                        'wiredfurni.params.movement.horizontal.distance',
                        ['distance'],
                        [horizontalDistance.toString()],
                    )}
                </Text>
                <Slider
                    max={MAX_DISTANCE}
            ...
            <div className="flex flex-col gap-2">
                ...
                <Text>
                    {LocalizeText(
                        'wiredfurni.params.movement.vertical.distance',
                        ['distance'],
                        [verticalDistance.toString()],
                    )}
                </Text>
                <Slider
                    max={MAX_DISTANCE}
