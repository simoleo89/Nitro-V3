...
export const renderPrizeIcon = (prize: IWheelPrize, large = false): ReactNode => {
    ...
    switch (prize.type) {
        ...
        case 'spin':
            return (
                <span className={large ? 'text-2xl font-bold text-[#2a3a42]' : 'text-xs font-bold text-[#2a3a42]'}>
                    +{prize.amount}
                </span>
            );
        default:
            return (
                <span
                    className={large ? 'text-2xl font-bold text-[#2a3a42]/60' : 'text-xs font-bold text-[#2a3a42]/60'}
                >
                    —
                </span>
            );
