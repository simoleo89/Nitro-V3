        ...
        >
            ...
            {badgeCodes.length === 0 ? (
                ...
                <div className="grid grid-cols-4 gap-1 max-h-[160px] overflow-y-auto">
                    ...
                    {filtered.length === 0 && (
                        <span className="text-xs text-white/40 col-span-4 text-center py-2">
...
export const InfoStandBadgeSlotView: FC<InfoStandBadgeSlotProps> = ({
    slotIndex,
    badgeCode: badgeCodeFromProps,
    isOwnUser,
}) => {
    const {
        activeBadgeCodes = [],
