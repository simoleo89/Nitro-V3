...
export const WiredConditionCounterTimeMatchesView: FC<{}> = () => {
    ...
    useEffect(() => {
        ...
        setFurniSource(
            trigger.intData.length > 3 ? trigger.intData[3] : (trigger.selectedItems?.length ?? 0) > 0 ? 100 : 0,
        );
    ...
    return (
        ...
        >
                    ...
                    return (
                        <div key={option.value} className="flex items-center gap-1">
                            <input
                                ...
                                className="form-check-input"
                                id={`counterComparison${option.value}`}
            ...
            <div className="flex flex-col gap-1">
                <Text bold>
                    {LocalizeText('wiredfurni.params.clock_minutes_elapsed', ['minutes'], [minutes.toString()])}
                </Text>
                <Slider
                    max={MINUTES_MAX}
                    min={MINUTES_MIN}
