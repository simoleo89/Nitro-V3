            ...
            <div ref={elementRef} className="relative">
                ...
                <AnimatePresence>
                    {isVisible && (
                        ...
                        >
                            <div className="text-white text-[13px] drop-shadow-[1px_1px_0_#000]">
        ...
        <div ref={elementRef} className="relative">
            ...
            <AnimatePresence>
                {isVisible && (
                    ...
                    >
                        <div className="text-white font-bold text-[13px] drop-shadow-[1px_1px_0_#000] truncate max-w-[120px] px-1">
                            {friend.name}
                        </div>
