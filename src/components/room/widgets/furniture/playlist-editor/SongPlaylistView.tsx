        ...
        <>
            <div className="bg-primary py-3 container-fluid justify-center flex rounded">
                <img
                    ...
                    src={GetConfigurationValue('image.library.url') + 'playlist/title_playlist.gif'}
                />
                            ...
                            return (
                                ...
                                >
                                    <div
                                        ...
                                        style={{
                                            backgroundColor:
                                                selectedItem === index ? '' : GetDiskColor(songInfo.songData),
                                        }}
            ...
            {(!playlist || playlist.length === 0) && (
                <>
                    ...
                    <img
                        className="add-songs"
                        src={GetConfigurationValue('image.library.url') + 'playlist/background_add_songs.gif'}
                    />
                </>
            )}
            {playlist && playlist.length > 0 && (
                    ...
                    {currentPlayingIndex !== -1 && (
                        <div className="flex gap-1">
                            ...
                            <div className="flex flex-col">
                                ...
                                <Text>
                                    {playlist[currentPlayingIndex]?.name +
                                        ' - ' +
                                        playlist[currentPlayingIndex]?.creator}
                                </Text>
                            </div>
                        </div>
                    )}
