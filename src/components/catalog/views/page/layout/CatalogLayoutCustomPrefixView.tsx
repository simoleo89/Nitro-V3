...
export const CatalogLayoutCustomPrefixView: FC<CatalogLayoutProps> = (props) => {
    ...
    const currentActiveColor =
        colorMode === 'single'
            ...
            : selectedLetterIndex !== null
              ? letterColors[selectedLetterIndex] || singleColor
              : singleColor;
    ...
    return (
        <div className="flex flex-col gap-2 h-full overflow-auto p-1">
            ...
            {/* Live Preview */}
            <div
                className="relative flex items-center justify-center p-4 rounded-lg min-h-[56px]"
                style={{
            ...
            >
                <div
                    ...
                    style={{
                        background: 'radial-gradient(ellipse at center, rgba(100,149,237,0.3) 0%, transparent 70%)',
                    }}
                />
                <span className="relative text-xl font-bold tracking-wide" style={effectStyle}>
                    ...
                    <span
                        style={hasMultiColor ? effectStyle : { ...effectStyle, color: previewColors[0] || '#FFFFFF' }}
                    >
                        {'{'}
                        {hasMultiColor
                            ? [...(prefixText || '...')].map((char, i) => (
                                  <span
                                      key={i}
                                      style={{
                                          color: previewColors[i] || previewColors[previewColors.length - 1],
                                          ...getPrefixEffectStyle(selectedEffect, previewColors[i]),
                                      }}
                                  >
                                      {char}
                                  </span>
            ...
            <div className="flex gap-2">
                <div className="flex flex-col gap-0.5 flex-1">
                    <label className="text-[11px] font-bold uppercase tracking-wider opacity-60">
                        {LocalizeText('catalog.prefix.text')}
                    </label>
                ...
                <div className="flex flex-col gap-0.5 relative">
                    <label className="text-[11px] font-bold uppercase tracking-wider opacity-60">
                        {LocalizeText('catalog.prefix.icon')}
                    </label>
            ...
            <div className="flex flex-col gap-1">
                <label className="text-[11px] font-bold uppercase tracking-wider opacity-60">
                    {LocalizeText('catalog.prefix.effect')}
                </label>
            ...
            <div className="flex flex-col gap-1">
                <label className="text-[11px] font-bold uppercase tracking-wider opacity-60">
                    {LocalizeText('catalog.prefix.color')}
                </label>
                <div className="flex rounded-md overflow-hidden" style={{ border: '1px solid rgba(0,0,0,0.15)' }}>
                    ...
                    <button
                        ...
                        onClick={() => {
                            setColorMode('perLetter');
                            if (prefixText.length > 0) setSelectedLetterIndex(0);
                        }}
                    >
                        ...
                        {[...prefixText].map((char, i) => {
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => {
                                        setSelectedLetterIndex(i);
                                        setCustomColorInput(charColor);
                                    }}
                                >
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    boxShadow: isActive
                                        ? `0 0 8px ${color}, 0 0 0 1px rgba(0,0,0,0.3)`
